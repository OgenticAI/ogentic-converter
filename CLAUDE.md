...
**Name:** ogentic-converter
**One-liner:** Synthetic-replica conversion primitive. The 'Convert' step in the privacy-aware AI pipeline.
**Owner:** David (CTO)
**Kind:** oss-library
...
- ruff + mypy strict
- Published to PyPI as `ogentic-converter`
...
Conversion must never persist source content or replicas beyond the call boundary unless the caller explicitly opts in via a documented param. Default = ephemeral.

**Deterministic for the same seed.**
Same input + same seed + same policy = same replica. Acceptance tests pin this property.
